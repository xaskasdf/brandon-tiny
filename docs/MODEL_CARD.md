...
tags:
  ...
  - denseformer
datasets:
  - xaskasdf/brandon-tiny-instruct
  - xaskasdf/brandon-tiny-synthetic-pretrain
  - wikimedia/wikipedia
...
- [Synthetic data](https://huggingface.co/datasets/xaskasdf/brandon-tiny-synthetic-pretrain) generated by GPT-4o-mini (30%)

**Instruction fine-tuning (75,502 examples):**
- [Brandon-Tiny Instruct dataset](https://huggingface.co/datasets/xaskasdf/brandon-tiny-instruct)
